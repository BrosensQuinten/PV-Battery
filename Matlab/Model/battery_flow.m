function [gen_pf,pf,pf_kwh,injectie,consumptie, battery_charge] = battery_flow(Efficiency,inverter, irr,load, surface_area, battery_capacity, battery_efficiency)
